<template>
	<div id="cart">
		...
		<div class="cart-bottom">
			<div class="cart-left">
				<i class="icon iconfont icon-31gouwuche" v-if="totalMoney <= 0" @click="isShowCart = !isShowCart">购物车</i>
				<i class="icon iconfont icon-31gouwuchexuanzhong" v-else @click="isShowCart = !isShowCart">选中</i>
